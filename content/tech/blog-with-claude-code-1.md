...
description: "AI 코딩 어시스턴트 Claude Code로 Next.js 블로그를 만들어봤다. 정리해둘 게 있어서 적어둔다."
date: "2025-02-04"
...
요즘 AI 코딩 도구가 좋아졌다길래, 이번엔 **Claude Code**한테 거의 다 맡겨봤다. "AI한테 블로그 만들어달라고 하면 어디까지 되나?" 싶었는데, 생각보다 잘 됐다.
...
- 개발자: git으로 관리, CMS 필요 없음

DB 붙이고 어드민 만들고... 그런 거 안 해도 된다. 일단 이게 나한텐 맞았다.
